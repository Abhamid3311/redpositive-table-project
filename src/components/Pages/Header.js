    ...
    return (
        <header className="navbar bg-neutral text-neutral-content">
            <div className="navbar-start">
                ...
                <Link to={'/'} className="btn btn-ghost normal-case text-2xl text-orange-700">Red Positive</Link>
            </div>
            ...
            <div className="navbar-end">
                <button href='#' className="btn btn-ghost hover:text-orange-700 mr-3">Login</button>
            </div>
        </header>
    );
};
